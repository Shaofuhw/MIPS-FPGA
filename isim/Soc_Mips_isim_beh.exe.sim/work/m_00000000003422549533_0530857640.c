...
#endif
static const char *ng0 = "C:/Users/Shao.Surface/Documents/Digital/Lab3v6/ForwardUnit.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
static int ng3[] = {2, 0};
...
LAB118:    t415 = (t179 + 4);
    t416 = *((unsigned int *)t179);
    t417 = *((unsigned int *)t415);
    t418 = (t416 || t417);
    if (t418 > 0)
        goto LAB119;

LAB120:    t420 = *((unsigned int *)t179);
    t421 = (~(t420));
...
LAB119:    t419 = ((char*)((ng1)));
    goto LAB120;

LAB121:    t424 = ((char*)((ng2)));
    goto LAB122;

LAB123:    xsi_vlog_unsigned_bit_combine(t178, 32, t419, 32, t424, 32);
    goto LAB127;

LAB125:    memcpy(t178, t419, 8);
    goto LAB127;
...
extern void work_m_00000000003422549533_0530857640_init()
{
	static char *pe[] = {(void *)Cont_30_0,(void *)Cont_32_1};
	xsi_register_didat("work_m_00000000003422549533_0530857640", "isim/Soc_Mips_isim_beh.exe.sim/work/m_00000000003422549533_0530857640.didat");
